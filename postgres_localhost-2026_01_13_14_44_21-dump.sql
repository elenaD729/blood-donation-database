...
\restrict vXhTcGuMHSZckARwOtd628ffTehA8nWTD25wC0a6aTIxc2xa4P7Me0qztqJeSOw
...
--
-- Name: employee_manager; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.employee_manager AS
 SELECT e.employee_id,
   ...
   FROM (public.employees e
     LEFT JOIN public.employees m ON ((e.reports_to = m.employee_id)));


ALTER VIEW public.employee_manager OWNER TO postgres;
...
CREATE TABLE public.medicalrecord (
    id integer NOT NULL,
    medications character varying(50),
...
--
-- Name: randomproducts; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.randomproducts AS
 SELECT product_id,
    product_name,
    unit_price
...
ALTER VIEW public.randomproducts OWNER TO postgres;
...
ALTER SEQUENCE public.table_name_id_seq OWNED BY public.employees.employee_id;
...
--
-- Name: transfusions; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.transfusions OWNER TO postgres;

--
-- Name: transfusions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.transfusions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.transfusions_id_seq OWNER TO postgres;

--
-- Name: transfusions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.transfusions_id_seq OWNED BY public.transfusions.id;
...
ALTER TABLE ONLY public.employees ALTER COLUMN employee_id SET DEFAULT nextval('public.table_name_id_seq'::regclass);
...
--
-- Name: transfusions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transfusions ALTER COLUMN id SET DEFAULT nextval('public.transfusions_id_seq'::regclass);
...
COPY public.categories (category_id, category_name, description, picture, picture_filename) FROM stdin;
2	Condiments	Sweet and savory sauces, relishes, spreads, and seasonings	\N	2Condiments.png
3	Confections	Desserts, candies, and sweet breads	\N	3Confections.png
4	Dairy Products	Cheeses	\N	4Dairy Products.png
5	Grains/Cereals	Breads, crackers, pasta, and cereal	\N	5Grains and Cereals.png
6	Meat/Poultry	Prepared meats	\N	6Meat and Poultry.png
7	Produce	Dried fruit and bean curd	\N	7Produce.png
8	Seafood	Seaweed and fish	\N	8Seafood.png
1	Beverages	de BAUT! Soft drinks, coffees, teas, beers, and ales	\N	1beverages.png
\.
...
COPY public.donations (id, donor_id, donation_date, quantity_ml) FROM stdin;
1	3	2025-10-11	450
2	5	2025-12-03	425
3	12	2025-11-11	440
4	1	2025-10-10	400
...
9	6	2025-10-15	450
10	7	2025-12-07	410
11	10	2025-12-04	450
12	9	2025-09-13	420
13	11	2025-11-03	450
14	15	2025-09-09	400
15	16	2025-09-08	420
16	13	2025-12-11	450
17	14	2025-10-10	450
18	7	2025-11-15	410
19	17	2025-10-02	440
20	18	2025-12-12	450
21	19	2025-10-10	400
22	9	2025-12-12	410
23	18	2025-11-14	450
24	3	2025-07-19	450
25	5	2025-12-18	400
26	7	2025-11-13	410
27	18	2025-12-04	450
\.
...
COPY public.donor (id, name, blood_type, date_of_birth) FROM stdin;
1	Mihai Alexandru	A+	2005-10-12
2	Elena Domide	AB+	2004-11-13
3	Daniel Socaciu	B-	2002-01-11
4	Alina Cirdan	AB-	1998-09-08
5	Ioana Florea	A+	1996-02-02
6	Maria Rus	B+	2005-04-01
7	Diana Andresi	A-	2001-02-11
8	Florin Popescu	AB-	1995-02-07
9	David Andreescu	A+	2005-04-11
10	Eduard Mihail	AB-	2003-11-23
11	Georgiana Savu	0+	2001-04-03
12	Luca Saveanu	0-	1998-10-11
13	Loredana Mihail	A-	2002-01-15
14	Dorina Sas	0+	2006-07-07
15	Daria Frasin	AB+	2001-01-01
16	Carla Pavelea	0-	2004-09-15
17	Florina Suciu	A+	2004-05-09
18	Florin Pop	AB-	1978-02-11
19	Andreea Domide	B-	2001-03-12
\.
...
COPY public.donors (id, name, blood_type, date_of_birth) FROM stdin;
1	Mihai Alexandru	A+	2005-10-12
2	Elena Domide	AB+	2004-11-13
3	Daniel Socaciu	B-	2002-01-11
4	Alina Cirdan	AB-	1998-09-08
...
COPY public.employees (employee_id, last_name, first_name, title, title_of_courtesy, birth_date, hire_date, address, city, region, postal_code, country, home_phone, extension, photo, notes, reports_to, photo_path, user_name, pass_word, salary, super_user) FROM stdin;
5	Buchanan	Steven	Sales Manager	Mr.	1955-03-04	1993-10-17	14 Garrett Hill	London		SW1 8JR	UK	(71) 555-4848	3453	\N	Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree in 1976.  Upon joining the company as a sales representative in 1992, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to sales manager in March 1993.  Mr. Buchanan has completed the courses Successful Telemarketing and International Sales Management.  He is fluent in French.	2	5Buchanan.jpg	SBuchanan	123456	1234	0
1	CENAN	Calin tenis	title	cour	1999-01-01	2011-02-02	Observator 1	Cluj-Napoca	Cluj	1234	Romania	0744796034	2	\N	tennis	\N	1Davolio.jpg	tenis	tenis	1010	0
4	Peacock	Margaret	Sales Representative	Mrs.	1937-09-19	1993-05-03	4110 Old Redmond Rd.	Redmond	WA	98052	USA	(206) 555-8122	5176	\N	Margaret holds a BA in English literature from Concordia College (1958) and an MA from the American Institute of Culinary Arts (1966).  She was assigned to the London office temporarily from July through November 1992.	2	\N	MPeacock	123456	1234	0
8	Callahan	Laura	Inside Sales Coordinator	Ms.	1958-01-09	1994-03-05	4726 - 11th Ave. N.E.	Seattle	WA	98105	USA	(206) 555-1189	2344	\N	Laura received a BA in psychology from the University of Washington.  She has also completed a course in business French.  She reads and writes French.	2	8Callahan.jpg	LCallahan	123456	1234	0
12	CENAN	Calinut	Lecturer	Mr.	1977-01-01	1999-01-01	Str. Obsertvator nr.1	Cluj-Napoca	CJ	1234	Romania	(555) 555-1234	1234	\N	My Notes	2	\N	altCenan	123456	2345	1
6	Suyama	Michael	Sales Representative	Mr.	1963-07-02	1993-10-17	Coventry House\\nMiner Rd.	London	\N	EC2 7JR	UK	(71) 555-7773	428	\N	Michael is a graduate of Sussex University (MA, economics, 1983) and the University of California at Los Angeles (MBA, marketing, 1986).  He has also taken the courses Multi-Cultural Selling and Time Management for the Sales Professional.  He is fluent in Japanese and can read and write French, Portuguese, and Spanish.	5	\N	MSuyama	123456	1234	0
7	King	Robert	Sales Representative	Mr.	1960-05-29	1994-01-02	Edgeham Hollow\\nWinchester Way	London	\N	RG1 9SP	UK	(71) 555-5598	465	\N	Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan in 1992, the year he joined the company.  After completing a course entitled Selling in Europe, he was transferred to the London office in March 1993.	5	\N	RKing	123456	1234	0
9	Dodsworth	Anne	Sales Representative	Ms.	1966-01-27	1994-11-15	7 Houndstooth Rd.	London	\N	WG2 7LT	UK	(71) 555-4444	452	\N	Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.	5	\N	ADodsworth	123456	1234	0
3	Leverling	Janice	Sales Representative	Ms.	1963-08-30	1992-04-01	722 Moss Bay Blvd.	Kirkland	WA	98033	USA	(206) 555-3412	3355	\N	Janet has a BS degree in chemistry from Boston College (1984).  She has also completed a certificate program in food retailing management.  Janet was hired as a sales associate in 1991 and promoted to sales representative in February 1992.	2	\N	JLeverling	123456	1234	0
10	CENAN	Calin	Lecturer	Dr.	1966-01-27	1994-11-15	Str. Baritiu nr. 26-28	Cluj-Napoca	\N	SW19	UK	(71)555-5555	123	\N	\N	\N	\N	CCENAN	123456	1234	1
2	Fuller	Andrew	Vice President, Sales	Dr.	1952-02-19	1992-08-14	908 W. Capital Way	Tacoma	WA	98401	USA	(206) 555-9482	3457	\N	Andrew received his BTS commercial in 1974 and a Ph.D. in international marketing from the University of Dallas in 1981.  He is fluent in French and Italian and reads German.  He joined the company as a sales representative, was promoted to sales manager in January 1992 and to vice president of sales in March 1993.  Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.	\N	2Fuller.jpg	AFuller	123456	1234	1
26	CENAN	Calin sexty	title	cour	1999-01-01	2011-02-02	Observator 1	Cluj-Napoca	Cluj	1234	Romania	0744796034	2	\N	20	8	26CENAN.jpg	q	q	1010	\N
\.
...
COPY public.hospital (id, hospital_name, email_contact, stock_lvl) FROM stdin;
1	Spitalul Clinic Județean de Urgență Cluj-Napoca	scjucj@gmail.com	5
2	Spitalul Clinic Municipal Cluj-Napoca	scmcj@gamil.com	5
3	Spitalul Clinic de Boli Infecțioase	scjbi@gmail.com	3
4	Institutul Inimii „Nicolae Stăncioiu”	scjbns@gmail.com	0
6	Spitalul Clinic de Recuperare	scr@gmail.com	0
5	Spitalul Militar de Urgență „Dr. Constantin Papilian”	smu@gmail.com	0
\.
...
COPY public.medicalrecord (id, medications, allergies, donor_id) FROM stdin;
1	Ibuprofen	NO	2
2	Nurofen	NO	18
3	NO	NO	3
4	Lisinopril	Penicillin	4
5	Aspirin	Penicillin	5
6	NO	NO	6
7	Ibuprofen	Aspirin	17
8	Amoxicillin	NO	12
9	Captopril	NO	15
10	NO	NO	7
11	Amoxacilin	Ibuprofen	1
12	Aspacardin	NO	8
13	NO	NO	9
14	NO	NO	11
15	Lisinopril	Nurofen	10
16	Captopril	Ibuprofen	13
17	NO	NO	14
18	Nurofen	NO	16
19	NO	NO	19
\.
...
COPY public.patient (id, name, blood_type, date_of_birth) FROM stdin;
1	Mihai Sofron	AB+	1998-02-11
2	Dan Sabau	B-	2004-09-02
3	George Sandu	AB-	2001-03-11
4	Simion Saicu	A+	2005-05-05
5	Dorina Simionescu	0+	2007-12-13
6	Sofia Munte	0-	2004-04-05
7	Mirabela Vaida	AB+	2003-02-18
8	Ioan Sofianu	B+	2002-11-17
9	Sanda Sigartau	A-	1990-05-14
10	Loredana Dobrin	AB-	2000-09-18
11	Corina Chira	B+	2009-03-11
12	Codruta Savu	0-	2010-10-10
13	Filip Popescu	A+	2001-02-04
14	Florina Fabian	B+	2011-11-11
15	Liana Biligan	A-	1978-06-06
16	Edina Muresan	AB+	1987-07-17
17	Ariana Pop	A-	2000-12-13
18	Floraian Popescu	0-	2004-01-01
19	Adrian Pop	AB-	2001-11-11
20	Mihail Alexandrescu	B-	2001-08-11
21	Sonia Lupu	AB+	1998-09-12
22	Roxana Popescu	A+	2008-03-15
\.
...
COPY public.sessions (session_id, data, ip, agent, stamp) FROM stdin;
8kbfb61on9u9nmlkvihrujqo6t		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.61	1698322126
sm6ubhp90jup34er6q3cva7nih		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.61	1698328258
oqvorj0cf9ag83c6va0pj7ohct		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698429888
f7e4g4414vm1m5j841f72c38ap		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698429951
ud6pq6ijosors679o4mja8538c		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698433131
tdrka9hvosj8vac1jpjb0bk43j		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698510515
646n0828uivh9vn99ed9ebm222		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698474772
6l405vn82pa3pbhr2sq19hshtc	session_id|s:26:"6l405vn82pa3pbhr2sq19hshtc";user_id|i:2;user_type|i:2;user_name|s:13:"Andrew Fuller";	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.76	1698658914
at8aksalce7163pjnb95eup8do	session_id|s:26:"at8aksalce7163pjnb95eup8do";user_id|i:2;user_type|i:2;user_name|s:13:"Andrew Fuller";	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698605607
ariu4vss6kna8vcnhoaltpn8tk		::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698477090
7sefafo55051f4grpdvo737lp0	session_id|s:26:"7sefafo55051f4grpdvo737lp0";user_id|i:8;user_type|i:1;user_name|s:14:"Laura Callahan";	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.69	1698524935
24g0ga6mfhgemqtejtn721h36k	session_id|s:26:"24g0ga6mfhgemqtejtn721h36k";user_id|i:2;user_type|i:2;user_name|s:13:"Andrew Fuller";	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.76	1698662834
ral2ans17oklg8nmi4d761cglc	session_id|s:26:"ral2ans17oklg8nmi4d761cglc";user_id|i:2;user_type|i:2;user_name|s:13:"Andrew Fuller";	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.76	1698695563
\.
...
--
-- Data for Name: transfusions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.transfusions (id, donation_id, hospital_id, patient_id, transfusion_date) FROM stdin;
1	1	3	2	2025-10-12
2	2	4	1	2025-12-05
3	3	6	7	2025-11-12
4	4	1	15	2025-10-11
...
8	8	5	6	2025-10-17
9	9	6	9	2025-12-08
10	10	5	8	2025-12-06
11	11	2	10	2025-09-16
12	12	1	11	2025-12-05
13	13	6	12	2025-09-10
14	14	3	13	2025-09-09
15	15	1	14	2025-12-13
16	16	5	16	2025-10-12
17	17	2	17	2025-10-03
18	18	6	18	2025-12-14
19	19	3	19	2025-10-11
20	20	1	4	2025-10-11
21	21	2	1	2025-12-12
22	22	5	7	2025-09-15
23	12	4	5	2025-11-02
24	1	5	8	2025-12-06
25	19	5	16	2025-10-12
26	24	1	17	2025-07-20
27	25	4	17	2025-12-19
28	26	1	17	2025-11-20
29	27	1	17	2025-12-20
\.
...
SELECT pg_catalog.setval('public.donor_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.donors_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.hospital_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.medicalrecord_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.patient_id_seq', 22, true);
...
--
-- Name: transfusions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.transfusions_id_seq', 29, true);
...
--
-- Name: medicalrecord medicalrecord_donor_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.medicalrecord
    ADD CONSTRAINT medicalrecord_donor_id_key UNIQUE (donor_id);
...
--
-- Name: transfusions transfusions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: donations f; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.donations
    ADD CONSTRAINT f FOREIGN KEY (donor_id) REFERENCES public.donors(id);


--
-- Name: medicalrecord f; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transfusions f; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transfusions
    ADD CONSTRAINT f FOREIGN KEY (donation_id) REFERENCES public.donations(id);
...
--
-- Name: transfusions g; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transfusions
    ADD CONSTRAINT g FOREIGN KEY (hospital_id) REFERENCES public.hospital(id);


--
-- Name: transfusions h; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transfusions
    ADD CONSTRAINT h FOREIGN KEY (patient_id) REFERENCES public.patient(id);
...
\unrestrict vXhTcGuMHSZckARwOtd628ffTehA8nWTD25wC0a6aTIxc2xa4P7Me0qztqJeSOw
